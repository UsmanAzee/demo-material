      ...
      <Fragment>
        <Dropzone
          ...
          className={classNames(
            ...
            this.props.error ? classes.dropZoneError : classes.dropZone
          )}
        ...
        {this.props.helperText && this.props.helperText !== "" && (
          <FormHelperText error={this.props.error} variant="standard">
...
export default withTheme(withStyles(styles, { withTheme: true })(DropzoneArea));
